...
import { getWorkspaceById, updateWorkspace } from "@/modules/project-management/workspace/hooks/workspaceHooks"
import { getMyProjectsByWorkspace, deleteProject } from "@/modules/project-management/project/hooks/projectHooks"
import { showError, showSuccess } from "@/utils/toast"
import { getAllTeams, createTeam } from "@/modules/project-management/team/hooks/teamHooks"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const projectRes = await getMyProjectsByWorkspace(res.data.workspace._id);
