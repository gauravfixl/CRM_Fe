  ...
  return (
    <section className="relative bg-[#0F172A] py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full opacity-10 blur-[100px]"
      ...
      <div className="relative max-w-[1280px] mx-auto px-6">
        ...
        >
          <motion.span
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 text-white/90 px-5 py-2 rounded-full text-xs font-semibold uppercase tracking-wider"
          ...
          <h2 className="mt-6 text-[34px] lg:text-[46px] font-bold text-white leading-tight">
        ...
        >
          <Link
            href="/auth/signup"
            className="inline-flex items-center gap-2.5 bg-white text-[#0F172A] font-semibold text-[15px] px-7 py-3.5 rounded-lg hover:bg-white/90 hover:gap-3.5 transition-all duration-300 shadow-lg shadow-white/10"
          >
