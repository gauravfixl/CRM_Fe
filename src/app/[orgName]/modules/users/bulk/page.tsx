        ...
        <div className="relative min-h-screen bg-[#F8F9FC] dark:bg-zinc-950">
            ...
            <div className="p-4 md:p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 shadow-sm flex items-center justify-between">
                        <div>
                        ...
                        <div className="h-12 w-12 rounded-none bg-primary/10 text-primary flex items-center justify-center">
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 shadow-sm flex items-center justify-between">
                        ...
                        <div className="h-12 w-12 rounded-none bg-emerald-50 text-emerald-600 flex items-center justify-center">
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 shadow-sm flex items-center justify-between">
                        ...
                        <div className="h-12 w-12 rounded-none bg-red-50 text-red-600 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-8 space-y-6">
                        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-10 shadow-sm relative overflow-hidden group">
                            ...
                            <div className="relative z-10 space-y-8">
                                ...
                                <div className="border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-none p-12 flex flex-col items-center justify-center bg-zinc-50/50 dark:bg-zinc-900/30 hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors cursor-pointer" onClick={handleUpload}>
                                    <div className="h-16 w-16 bg-white dark:bg-zinc-800 rounded-none shadow-md flex items-center justify-center mb-4 group-hover:rotate-6 transition-transform">
                                ...
                                {isUploading && (
                                    <div className="space-y-3">
                                        <div className="flex justify-between text-xs font-bold">
                                            <span className="text-primary">Syncing directory...</span>
                                            <span>82%</span>
                                        </div>
                        ...
                        {/* Integration Info */}
                        <div className="bg-zinc-900 dark:bg-white rounded-none p-8 text-white dark:text-zinc-900 shadow-xl relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                ...
                                <CustomButton className="bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white font-semibold rounded-none text-xs h-10 px-6 border-0 shadow-lg" onClick={() => toast.info("Configuring SCIM endpoint...")}>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={idx} className="flex flex-col gap-1 p-3 rounded-none hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors cursor-pointer group">
                                        <div className="flex justify-between items-start">
                                            <span className="text-xs font-bold text-zinc-700 dark:text-zinc-300">{item.label}</span>
                                            <Badge variant="outline" className={`text-[8px] font-semibold px-1.5 py-0 ${item.status === 'Success' ? 'text-emerald-500' : 'text-amber-500'}`}>{item.status}</Badge>
                                        </div>
                            ...
                            <CustomButton variant="ghost" className="w-full mt-4 text-[11px] font-semibold text-primary" onClick={() => toast.info("Viewing full sync audit trail")}>
                                View full logs <ChevronRight className="ml-1 w-3.5 h-3.5" />
                            </CustomButton>
                        </div>

                        <div className="bg-primary/5 dark:bg-primary/10 border border-primary/20 dark:border-primary/20 rounded-none p-6">
                            <div className="flex items-center gap-2 text-primary mb-2">
                                <Settings className="w-4 h-4" />
                                <span className="text-[10px] font-bold ">Configuration</span>
                            </div>
                            <h6 className="text-[11px] font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Sync behavior</h6>
                            <div className="space-y-3">
