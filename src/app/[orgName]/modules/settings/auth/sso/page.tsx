        ...
        <div className="relative min-h-screen bg-[#F8F9FC] dark:bg-zinc-950">
            <SubHeader
                ...
                rightControls={
                    <div className="flex gap-2">
                        <CustomButton onClick={() => toast.info("Opening provider connection wizard")} className="bg-zinc-900 text-white hover:bg-zinc-800 rounded-lg h-10 px-6 font-bold text-xs tracking-widest shadow-xl border-0">
            ...
            <div className="p-4 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex items-center gap-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-2 rounded-xl shadow-sm">
                    ...
                    <div className="flex gap-2">
                        <CustomButton onClick={() => toast.info("Syncing all identity providers...")} variant="ghost" className="rounded-lg h-10 px-4 font-bold text-xs tracking-widest text-zinc-500 border border-transparent hover:border-zinc-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
                    {providers.map((p) => (
                        <Card key={p.id} className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm hover:shadow-2xl transition-all group border-t-4 border-t-zinc-900 data-[status=Connected]:border-t-indigo-600" data-status={p.status}>
                            <CardHeader className="flex flex-row items-center justify-between pb-4">
                                ...
                                <CustomButton onClick={() => toast.info("Provider options")} variant="ghost" size="icon" className="text-zinc-400 rounded-lg">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="pt-2 border-t border-zinc-50 dark:border-zinc-800/50 flex items-center justify-between">
                                    ...
                                    <CustomButton onClick={() => toast.info("Viewing endpoints")} variant="ghost" className="h-10 text-xs text-zinc-500 font-bold tracking-widest hover:text-indigo-600 group-hover:translate-x-1 transition-transform">
                    ...
                    <div onClick={() => toast.info("Setting up custom IdP")} className="border-4 border-dashed border-zinc-100 dark:border-zinc-800 p-8 flex flex-col items-center justify-center text-center space-y-6 hover:border-indigo-500/20 transition-all cursor-pointer group bg-zinc-50/10 dark:bg-zinc-900/10 rounded-2xl">
                ...
                <div className="bg-[#121212] p-8 rounded-2xl text-white shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8 mt-12 relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-4">
                        ...
                        <div className="flex gap-4">
                            <CustomButton onClick={() => toast.info("Opening SCIM configuration")} className="bg-white text-zinc-900 hover:bg-zinc-200 rounded-lg h-12 px-8 font-bold text-xs tracking-widest border-0">
                                Configure SCIM v2.0
                            </CustomButton>
                        </div>
                    </div>
