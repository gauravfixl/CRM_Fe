                                ...
                                <tr key={role.id} className="hover:bg-blue-50/30 transition-colors group">
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-xs font-medium text-gray-900">{role.role}</span>
                                        </div>
                                    </td>
                                    <td className="px-4 py-3"><Switch checked={role.viewInvoices} className="data-[state=checked]:bg-green-600" /></td>
                                    <td className="px-4 py-3"><Switch checked={role.createInvoices} className="data-[state=checked]:bg-green-600" /></td>
                                    <td className="px-4 py-3"><Switch checked={role.editTax} className="data-[state=checked]:bg-green-600" /></td>
                                    <td className="px-4 py-3"><Switch checked={role.deleteInvoices} className="data-[state=checked]:bg-green-600" /></td>
                                    <td className="px-4 py-3"><Switch checked={role.viewReports} className="data-[state=checked]:bg-green-600" /></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
