        ...
        <div className="space-y-6 text-[#1A1A1A]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white border border-zinc-200 p-4 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900">$45,280</h3>
                    <p className="text-green-600 text-[10px] mt-1">This quarter</p>
                </div>
                <div className="bg-white border border-zinc-200 p-4 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                    <p className="text-gray-600 text-xs">Avg. Compliance</p>
                    <h3 className="text-xl font-semibold text-gray-900">97.7%</h3>
                    <p className="text-blue-600 text-[10px] mt-1">Excellent</p>
                </div>
                <div className="bg-white border border-zinc-200 p-4 rounded-xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
