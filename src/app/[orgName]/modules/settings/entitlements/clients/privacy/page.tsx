    ...
    return (
        <div className="flex flex-col gap-6 p-6 min-h-screen bg-[#fafafa]">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <h1 className="text-sm font-semibold text-zinc-900">Data Retention & Privacy</h1>
                            <Badge className="bg-blue-50 text-blue-600 border-none text-[10px] font-medium px-2 rounded-md">GDPR Compliant</Badge>
                        </div>
                        <p className="text-xs text-slate-500">Manage data protection, privacy policies, and regulatory compliance for client information.</p>
                    </div>
                </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <SmallCard className="bg-gradient-to-r from-primary/70 to-primary border-none text-white shadow-lg rounded-xl">
                    <SmallCardHeader className="flex flex-row items-center justify-between pb-1 px-4 pt-4">
                        <p className="text-xs opacity-80">Privacy Score</p>
                        <ShieldCheck className="w-4 h-4 text-white" />
                    </SmallCardHeader>
                    <SmallCardContent className="px-4 pb-4">
                        <p className="text-xl font-semibold text-white">98.5%</p>
                ...
                <SmallCard className="border bg-white shadow-sm rounded-xl">
                    ...
                    <SmallCardContent className="px-4 pb-4">
                        <p className="text-xl font-semibold text-zinc-900">100%</p>
                        <p className="text-[10px] text-slate-500">AES-256 encryption</p>
                    </SmallCardContent>
                </SmallCard>

                <SmallCard className="border bg-white shadow-sm rounded-xl">
                    <SmallCardHeader className="flex flex-row items-center justify-between pb-1 px-4 pt-4">
                        <p className="text-xs text-slate-500">PII Fields Masked</p>
                        <EyeOff className="w-4 h-4 text-zinc-300" />
                    </SmallCardHeader>
                    <SmallCardContent className="px-4 pb-4">
                        <p className="text-xl font-semibold text-zinc-900">12 Fields</p>
                        <p className="text-[10px] text-slate-500">Protected data</p>
                    </SmallCardContent>
                </SmallCard>
                ...
                <SmallCard className="border bg-white shadow-sm rounded-xl">
                    ...
                    <SmallCardContent className="px-4 pb-4">
                        <p className="text-xl font-semibold text-zinc-900">24,847</p>
                        <p className="text-[10px] text-slate-500">Access events logged</p>
                    </SmallCardContent>
                </SmallCard>
            </div>
            ...
            <div className="bg-white rounded-xl border shadow-sm p-5">
                <h3 className="text-sm font-semibold text-zinc-900 mb-4">Privacy & Compliance Policies</h3>
            ...
            <div className="p-5 bg-zinc-900 rounded-xl text-white shadow-lg relative overflow-hidden">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
                    <div className="flex gap-4 items-center">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold mb-1 text-blue-400">Regulatory Compliance</h4>
...
function PolicyToggle({ title, description, icon: Icon, checked, onCheckedChange, color = "blue" }: any) {
    return (
        <div className={`flex items-start justify-between p-4 rounded-xl border border-zinc-100 hover:border-${color}-100 transition-all group`}>
            <div className="flex gap-3">
                <div className={`w-9 h-9 rounded-lg bg-zinc-50 group-hover:bg-${color}-50 flex items-center justify-center text-zinc-400 group-hover:text-${color}-600 transition-colors shadow-sm`}>
                    <Icon className="w-4 h-4" />
                </div>
                <div>
                    <h4 className="text-xs font-medium text-zinc-800 mb-1">{title}</h4>
                    <p className="text-[10px] text-slate-500 font-medium leading-relaxed pr-4">{description}</p>
                </div>
            </div>
            <Switch
                checked={checked}
