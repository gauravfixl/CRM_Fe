    ...
    return (
        <div className="font-outfit flex flex-col gap-6 p-6 min-h-screen bg-[#fafafa]">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <SmallCard className="rounded-xl border bg-gradient-to-r from-primary/70 to-primary text-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"><SmallCardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-xs text-white/80">Active Policies</p><p className="text-xl font-semibold text-white tracking-tight">{policies.length}</p><p className="text-[10px] text-white/70">Reimbursement rules</p></div><Receipt className="w-5 h-5 text-white/80" /></div></SmallCardContent></SmallCard>
