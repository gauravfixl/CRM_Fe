            ...
            <Card className="border-none shadow-sm bg-white rounded-[40px] overflow-hidden">
                <CardContent className="p-10 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input defaultValue="Fixl Solutions" className="h-11 bg-slate-50 border-none rounded-none px-4 font-semibold text-slate-800 focus:ring-4 focus:ring-indigo-500/10 transition-all" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[12px] font-bold text-slate-500 ml-1">Access URL</label>
                                <div className="flex items-center gap-2">
                                    <div className="h-11 flex items-center px-4 bg-slate-100 rounded-none text-slate-400 font-bold text-xs">fixl.app/</div>
                                    <Input defaultValue="workspace-alpha" className="h-11 bg-slate-50 border-none rounded-none px-4 font-semibold text-indigo-600 focus:ring-4 focus:ring-indigo-500/10 transition-all flex-1" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-6">
                                <div className="h-28 w-28 bg-slate-50 rounded-none border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 gap-1.5 hover:bg-white hover:border-indigo-300 transition-all cursor-pointer group">
                                ...
                                <div className="space-y-2 flex-1">
                                    ...
                                    <Button variant="outline" className="h-9 rounded-none border border-slate-200 font-bold text-[11px] text-slate-600">Change Image</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-10 border-t border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 bg-slate-50/50 rounded-none space-y-4 border border-slate-100">
                    ...
                    <div className="flex items-center justify-between pt-10 border-t border-slate-100">
                        ...
                        <Button className="h-11 px-8 bg-indigo-600 hover:bg-indigo-700 text-white rounded-none font-bold text-[13px] shadow-lg shadow-indigo-100 gap-2">
                            <Save size={16} />
                            Commit Changes
                        </Button>
                    </div>
