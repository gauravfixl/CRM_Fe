                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card className="border-none shadow-sm bg-slate-900 text-white p-10 rounded-[3rem] relative overflow-hidden group">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                            ...
                            <Button className="bg-white text-slate-900 hover:bg-indigo-50 rounded-xl h-12 px-8 font-black uppercase text-[10px] tracking-widest transition-all shadow-xl">
                                INITIATE SPRINT
                            </Button>
                        </div>
                    </Card>
