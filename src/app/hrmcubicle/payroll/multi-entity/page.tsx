        ...
        <div className="flex flex-col h-full bg-[#f8fafc] font-sans overflow-y-auto" style={{ zoom: "67%" }}>
            ...
            <div className="flex-1 p-8 space-y-6 pb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    {[
                        { label: "Total Entities", val: entities.length, icon: Building2, color: "text-[#8B5CF6]", bg: "bg-[#8B5CF6]/10" },
                        { label: "Total Employees", val: totalEmployees, icon: Users, color: "text-blue-500", bg: "bg-blue-50" },
                        { label: "Total Payroll Cost", val: `₹${(totalCost / 10000000).toFixed(2)}Cr`, icon: DollarSign, color: "text-emerald-500", bg: "bg-emerald-50" },
                        { label: "Active Locations", val: locations.length, icon: MapPin, color: "text-amber-500", bg: "bg-amber-50" },
                    ].map((s, i) => (
