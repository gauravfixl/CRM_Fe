        ...
        <>
            <SubHeader
                ...
                breadcrumbItems={[
                    ...
                    { label: "Pipeline", href: `/${orgName}/modules/crm/pipeline` },
                ]}
            />
            ...
            <div className="p-4">
                <FlatCard className="min-h-[60vh] flex flex-col items-center justify-center text-center">
                    <FlatCardHeader>
                        ...
                        <FlatCardTitle className="text-2xl">Sales Pipeline Coming Soon</FlatCardTitle>
                        <FlatCardDescription className="max-w-md mx-auto mt-2">
                            Visualise your sales process. This module will allow you to customize pipeline stages
                            and drag-and-drop deals to move them forward.
                        </FlatCardDescription>
                    </FlatCardHeader>
                </FlatCard>
            </div>
