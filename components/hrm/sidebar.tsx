...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-16 hidden h-[calc(100vh-64px)] w-64 shrink-0 border-r bg-sidebar text-sidebar-foreground md:block overflow-x-hidden hide-scrollbar">
      <div className="flex flex-col gap-2 p-3">
        {items.map((item) => {
          const active =
            pathname === item.href ||
